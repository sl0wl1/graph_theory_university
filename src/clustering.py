...
def group_after_invariant(list_reactions: List[Dict[Any, Any]], invariant: str) -> Dict[str, Any]:
    ...
    invariants = ["vertex_count", "edge_counts", "vertex_degrees", "algebraic_connectivity", "rank"]
...
def cluster_after_invariant_grouping(group_dict: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
